            ...
            <div className="flex-grow flex flex-col md:flex-row justify-between md:items-start gap-12">
                <div className="max-w-xl">
                    ...
                    <div className="flex flex-col items-start gap-4 mt-12">
                         <a href={`mailto:${COMPANY_INFO.email}`} className="group relative text-xl md:text-2xl font-light text-gray-300 hover:text-white transition-colors duration-300">
                            {COMPANY_INFO.email}
                            <span className="absolute left-0 bottom-0 w-full h-[1px] bg-white scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left"/>
                        </a>
